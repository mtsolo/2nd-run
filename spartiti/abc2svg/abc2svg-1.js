...
if(se<0)
se=eof
if(typeof stag!="object"){if(stag[0]!='b'&&stag[0]!='a'&&stag[0]!='+')
stag='b'+stag
if(stag[1]!='<')
stag=stag[0]+"<pre>"
r=stag.match(/<\/?[^>]*>/g)
...
if(typeof document!="undefined"){strwh(s.a_ly[0].t)
...
abc2svg.version="v1.22.21";abc2svg.vdate="2024-10-20"
